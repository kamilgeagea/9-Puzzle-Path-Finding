...
avg_sol_h1 = tot_sol_h1/20
print("Sum_h1: " + str(sum_ET_h1))
print("Avg_h1: " + str(avg_ET_h1))
print("Sum_SP_h1: " + str(sum_SP_h1))
print("Avg_SP_h1: " + str(avg_SP_h1))
print("Tot_Sol_h1 " + str(tot_sol_h1))
print("Avg_Sol_h1 " + str(avg_sol_h1))


avg_ET_h2 = sum_ET_h2/20
avg_SP_h2 = sum_SP_h2/20
avg_sol_h2 = tot_sol_h2/20
print("Sum_ET_h2: " + str(sum_ET_h2))
print("Avg_ET_h2: " + str(avg_ET_h2))
print("Sum_SP_h2: " + str(sum_SP_h2))
print("Avg_SP_h2: " + str(avg_SP_h2))
print("Tot_Sol_h2 " + str(tot_sol_h2))
print("Avg_sol_h2 " + str(avg_sol_h2))


# Analysis 2.
avg_NS_dfs = float(tot_NS_dfs)/3
avg_NS_id = float(tot_NS_id)/3
print("Tot_NS_dfs: " + str(tot_NS_dfs))
print("Avg_NS_dfs: " + str(avg_NS_dfs))
print("Tot_NS_id: " + str(tot_NS_id))
print("Avg_NS_id: " + str(avg_NS_id))
